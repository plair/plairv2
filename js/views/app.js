define([
  ...
  var AppView = Backbone.View.extend({
    ...
    initialize: function(){
      ...
      var testcollection = new YoutubeVideoCollection([{youtubeCode:"l4A_L6Bs0o8", trackNumber:22, title:"Made In U.S.A. - Melodies 1977", currentTrack:false},{youtubeCode:"eMQmzLFd7JU", trackNumber:23, title:"Double Exposure - My Love Is Free (12' Special Disco Mix)", currentTrack:false},{youtubeCode:"df0rlvjxl_A", trackNumber:24, title:"Meli'sa Morgan - Still In Love (House version)", currentTrack:false},{youtubeCode:"CIU66esH3js", trackNumber:25, title:"Mc Lyte - Everyday", currentTrack:false},{youtubeCode:"S8K31tTV554", trackNumber:26, title:"Spice 1 - Welcome To The Ghetto", currentTrack:false},{youtubeCode:"a4u8WPX7JZU", trackNumber:27, title:"If This World Were Mine - Marvin Gaye & Tammi Terrell", currentTrack:false},{youtubeCode:"2RpkXyhbMLA", trackNumber:28, title:"Royce Da 5'9 - Let's Grow", currentTrack:false},{youtubeCode:"7O_l7O4PpDI", trackNumber:29, title:"Zé Rodrix - Xamego Da Nega.", currentTrack:false},{youtubeCode:"YSPQfjgC8Os", trackNumber:21, title: "Two Tons O' Fun - Just Us", currentTrack:false}, {youtubeCode:"JBXfyCXlzz0", trackNumber:30, title:"Frankie Knuckles Live From the Warehouse Chicago in 1977", currentTrack:false},{youtubeCode:"UxPEmLu1-Go", trackNumber:31, title:"DJ Screw - Stressed Out (Side A & B)", currentTrack:false}]);
